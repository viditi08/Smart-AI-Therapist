...
const features = [
  {
    ...
    description: "Talk to Emma through a natural voice conversation.",
  },
  {
  ...
  },
  {
    ...
    description: "Speak naturally and hear Emma respond.",
  },
];
        ...
        <section className="hero">
          ...
          <div className="container hero-inner">
            ...
            <p className="hero-lead">
              A real back-and-forth: you speak, Emma listens and responds
            ...
            <dl className="stats">
              ...
              <div className="stat">
                ...
                <dd>
                  ...
                  <span>Natural speech · spoken replies</span>
                </dd>
              </div>
              <div className="stat">
        ...
        <section id="features" className="section features">
          <div className="container">
            <div className="section-head">
              ...
              <p className="section-sub">
                Voice-to-voice sessions with space to reflect, pause, and feel heard.
              </p>
            </div>
